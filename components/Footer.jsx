...
const Footer = () => (
  <footer id="contact" className="section contact">
    <div className="w-container">
      ...
      <div className="w-row">
        <div className="w-col w-col-4 direccion">
          <div className="icon-wrapper">
            <img src={marcador} alt="icono mapa" width="44" />
          </div>
          ...
          <a
            href="https://www.ctic.uni.edu.pe/"
            target="_blank"
            rel="noreferrer"
          >
            <img src={logoCTIC} width="197" alt="logo ctic" />
          </a>
        </div>

        <div className="w-col w-col-4">
          <div className="icon-wrapper _2">
            <img src={carta} alt="icono carta" width="70" />
          </div>
        ...
        <div className="w-col w-col-4">
          <div className="icon-wrapper _2">
            <img src={corazon} alt="icono corazon" width="68" />
          </div>
          ...
          <Icono
            texto="LinkedIn"
            icono="linkedin"
            url="https://www.linkedin.com/company/laboratorio-smart-machines-ctic-uni/"
          />
        </div>
      </div>
    </div>
